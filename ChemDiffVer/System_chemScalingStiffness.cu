...
//	generalParams.edges_in_upperhem.resize(coordInfoVecs.num_edges);
	...
	while (runSim == true){
		...
		utilities_ptr->chemSignal_weakening_update_host_vecs(max_conc,
		generalParams,
		coordInfoVecs,
		hostSetInfoVecs)
