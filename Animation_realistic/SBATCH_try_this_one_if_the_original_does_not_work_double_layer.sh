...
#SBATCH --output=_double_layer_circular_flat_Test_Dsp# This affects the print out of the "std::cout" in the script, make sure this is changed for different jobs.
